...
export const IMPOSIBLE_FIND_AIRPORT_TO_CREATE_IT_ERROR_MESSAGE =
  "Imposible to find airport param to save"
...
export const createAirportHandler = async (
  ...
  if (airport) {
    try {
      const airportCreated = (await AirportModel.create(airport)) as Document<
        Airport,
        {}
      >
